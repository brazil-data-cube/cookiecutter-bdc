...
"""Configuration file for the {{ cookiecutter.project_title }} documentation.
...
project = '{{ cookiecutter.package_name | upper }}'
copyright = '{{ cookiecutter.copyright_year }}, INPE.'
...
html_title = '{{ cookiecutter.package_name | upper }}'

html_context = {
    'display_github': False,
    'github_user': 'brazil-data-cube',
    'github_repo': '{{ cookiecutter.project_directory }}',
    'last_updated': False,
    #'commit': False,
}
...
#import os
#
#{{ cookiecutter.package_name | upper }}_EXAMPLE_URL = os.getenv('{{ cookiecutter.package_name | upper }}_EXAMPLE_URL', None)
#'''
